  ...
  module Workable
    module ApplicationFields
      ...
      def get_application_question_set(_job, data)
        ...
        formatted_data = Importer::WorkableFieldsFormatter.call(hashed_form_data(form_data).with_indifferent_access)
      ...
      def hashed_form_data(form_data)
        form_data.each_with_object({}) do |item, hash|
          hash[item['name']] = { fields: item['fields'] }
        end
      end
