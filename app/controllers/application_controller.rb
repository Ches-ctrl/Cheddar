class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update,
                                      keys: [:first_name, :last_name, :address_first, :address_second, :city, :post_code, :phone_number, :github_profile_url,
                                             :website_url, :photo, :resume, :linkedin_profile, :preferred_pronoun_select, :preferred_pronoun_text, :salary_expectation_figure, :right_to_work, { cover_letter_templates: [] }])
  end
