    ...
    return {
      DEFAULT: {
        css: {
          ...
          "--tw-prose-links": theme("colors.mauve.700"),
          "--tw-prose-links-hover": theme("colors.mauve.800"),
          "--tw-prose-links-underline": theme("colors.mauve.500 / 0.3"),
          ...
          "--tw-prose-invert-links": theme("colors.mauve.400"),
          "--tw-prose-invert-links-hover": theme("colors.mauve.500"),
          "--tw-prose-invert-links-underline": theme("colors.mauve.500 / 0.3"),
