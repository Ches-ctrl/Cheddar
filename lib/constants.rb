...
module Constants
  ...
  JOB_TITLE_KEYWORDS = [
    ...
    /software/i,
    /\bweb\b/i,
    /(?:technical|technology|digital) (?:artist|designer|graduate|lead|support)/i,
    ...
    /infrastructure (?:analyst|engineer|architect)/i,
    /platform (?:analyst|engineer|architect)/i,
    /security (?:analyst|engineer|architect)/i,
    /cloud (?:analyst|engineer|architect)/i,
    /network (?:analyst|engineer|architect)/i,
